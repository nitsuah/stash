...
- Docs: [[repos/fire/README|README]] (every doc hangs off its Docs Index)
- Overview: [[projects/KB/fire-overview|KB overview]]
- Latest LOC report: [[reports/eng-loc-fire-2026-09-16|2026-09-16]] (older ones chain from it)
- Latest MINI report: [[reports/eng-mini-fire-2026-09-24|2026-09-24]] (older ones chain from it)
<!-- vault-links:end -->
