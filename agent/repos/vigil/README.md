...
![Architecture](https://github.com/nitsuah/vigil/blob/main/docs/diagrams/architecture.svg)

### Screenshots

**Dashboard** — [`docs/screenshots/dashboard.png`](https://github.com/nitsuah/vigil/blob/main/docs/screenshots/dashboard.png)

![Dashboard](https://github.com/nitsuah/vigil/blob/main/docs/screenshots/dashboard.png)

**Pmo** — [`docs/screenshots/pmo.png`](https://github.com/nitsuah/vigil/blob/main/docs/screenshots/pmo.png)

![Pmo](https://github.com/nitsuah/vigil/blob/main/docs/screenshots/pmo.png)

**Repo details** — [`docs/screenshots/repo-details.png`](https://github.com/nitsuah/vigil/blob/main/docs/screenshots/repo-details.png)

![Repo details](https://github.com/nitsuah/vigil/blob/main/docs/screenshots/repo-details.png)
