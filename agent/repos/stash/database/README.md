---
up: "[[repos/stash]]"
source: https://github.com/nitsuah/stash/blob/main/database/README.md
kind: repo-doc
repo: stash
---
...
| Directory | Covers |
|-----------|--------|
| [`postgres/`](https://github.com/nitsuah/stash/tree/main/database/postgres) | Schema DDL, indexes, RLS, partitioning, CTEs, window functions, JSONB, full-text search |
| [`mongodb/`](https://github.com/nitsuah/stash/tree/main/database/mongodb) | CRUD, aggregation pipeline, schema validation, indexes, transactions, text search |
...
**File:** [`mongodb/examples.py`](https://github.com/nitsuah/stash/blob/main/database/mongodb/examples.py)
