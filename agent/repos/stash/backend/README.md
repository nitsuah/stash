---
up: "[[repos/stash]]"
source: https://github.com/nitsuah/stash/blob/main/backend/README.md
kind: repo-doc
repo: stash
---
...
|-----------|---------------------|-----|------|
| [`flask/`](https://github.com/nitsuah/stash/tree/main/backend/flask) | Python / Flask | SQLAlchemy | JWT (PyJWT) |
| [`express/`](https://github.com/nitsuah/stash/tree/main/backend/express) | Node.js / Express | Sequelize | JWT (jsonwebtoken) |
