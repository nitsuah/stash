---
up: "[[repos/stash]]"
source: https://github.com/nitsuah/stash/blob/main/atlassian/README.md
kind: repo-doc
repo: stash
---
...
Python examples for the Atlassian Cloud product suite. Each script is self-contained and runnable independently. All use a shared base client from [`client.py`](https://github.com/nitsuah/stash/blob/main/atlassian/client.py).
...
| [`jira/groovy/users.groovy`](https://github.com/nitsuah/stash/blob/main/atlassian/jira/groovy/users.groovy) | Jira Server — ScriptRunner user listing | Jira Server admin |
...
- [`jira/validate_project.py`](https://github.com/nitsuah/stash/blob/main/atlassian/jira/validate_project.py) — validates a Jira project's full configuration (workflows, issue types, custom fields, lifecycle suites)
