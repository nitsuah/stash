---
up: "[[repos/stash]]"
source: https://github.com/nitsuah/stash/blob/main/cloud/README.md
kind: repo-doc
repo: stash
---
...
| Path | Type | Covers |
|------|------|--------|
| [`aws/examples.py`](https://github.com/nitsuah/stash/blob/main/cloud/aws/examples.py) | boto3 examples | EC2, S3, IAM, SSM, CloudWatch, Lambda, RDS, ECS, CloudFormation, Route53 |
| [`iac/ubuntu-userdata.sh`](https://github.com/nitsuah/stash/blob/main/cloud/iac/ubuntu-userdata.sh) | EC2 UserData | Ubuntu 22.04: Docker, CloudWatch agent, sysctl hardening |
| [`iac/windows-userdata.ps1`](https://github.com/nitsuah/stash/blob/main/cloud/iac/windows-userdata.ps1) | EC2 UserData | Windows Server 2022: Chocolatey, IIS, CloudWatch agent, TLS/SMB hardening |
