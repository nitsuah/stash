...
| Script | Covers |
|--------|--------|
| [`oauth2.py`](https://github.com/nitsuah/stash/blob/main/sso/oauth2.py) | OAuth 2.0 / OIDC — auth code + PKCE, token exchange, refresh, introspection, client credentials, UserInfo |
| [`saml.py`](https://github.com/nitsuah/stash/blob/main/sso/saml.py) | SAML 2.0 — IdP metadata parsing, AuthnRequest, SAMLResponse parsing, SP metadata generation |
| [`aws_sso.py`](https://github.com/nitsuah/stash/blob/main/sso/aws_sso.py) | AWS IAM Identity Center — device auth flow, list accounts/roles, get temp credentials, Okta SCIM pattern |
