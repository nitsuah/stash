...
This is a comprehensive, centralized index for all repository summary files and deep documentation.

| Repo | Knowledge Synthesis | Deep Docs |
| --- | --- | --- |
| agent-board | [[projects/KB/agent-board-overview.md|Synthesis]] | [[repos/agent-board/docs/API.md|API]], [[repos/agent-board/docs/ARCHITECTURE.md|ARCH]], [[repos/agent-board/docs/SETUP_INSTRUCTIONS.md|SETUP]], [[repos/agent-board/docs/AI_STACK_STRATEGY.md|AI_STRAT]] |
| auto-apply-plugin | [[projects/KB/auto-apply-plugin-overview.md|Synthesis]] | [[repos/auto-apply-plugin/docs/PRIVACY.md|PRIVACY]] |
| avatar | [[projects/KB/avatar-overview.md|Synthesis]] | |
| bb-mcp | [[projects/KB/bb-mcp-overview.md|Synthesis]] | |
