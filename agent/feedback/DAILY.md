...
- nitsuah-io - CSS files (resume.css 1,648) - LOW - CSS-only concern; component styles
- overseer - github.ts (815)  API wrapper is doing too much
- vhs - index.html (3,094) & inventory.js (880), Structural — needs componentization, not just splitting.

## tire kick again - skipped Repos
